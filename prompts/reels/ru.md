...
All output (concept, script, scene descriptions) must be in **{{language}}**. Ensure cultural appropriateness, natural idioms, and native-level fluency. Use Cyrillic script for Russian language output.

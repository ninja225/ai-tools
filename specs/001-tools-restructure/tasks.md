...
- [ ] T001 Remove image-prompt tool: delete src/config/tools/image-prompt.ts
- [ ] T002 Remove image-prompt tool prompts: delete prompts/image-prompt/ directory
- [ ] T003 [P] Update tool registry in src/config/tools/index.ts to remove image-prompt
- [ ] T004 [P] Add file input type to ToolInput union in src/types/tool.ts
...
- [ ] T005 Create ImageUpload component in src/components/tools/image-upload.tsx with client-side preview and validation
- [ ] T006 Create prompt-loader utility in src/lib/utils/prompt-loader.ts for dynamic prompt loading with placeholder replacement
- [ ] T007 [P] Add image upload translations to src/messages/en.json
- [ ] T008 [P] Add image upload translations to src/messages/ru.json
- [ ] T009 [P] Add image upload translations to src/messages/ar.json
- [ ] T010 Audit all existing pages for missing translations - run scripts/audit-translations.js to compare src/app/**/page.tsx getTranslations() calls against src/messages/*.json keys, generate missing-keys.md report
- [ ] T011 [P] Complete navigation and layout translations in src/messages/en.json (header, footer, navigation menu)
- [ ] T012 [P] Complete navigation and layout translations in src/messages/ru.json with proper Russian terminology
- [ ] T013 [P] Complete navigation and layout translations in src/messages/ar.json with RTL considerations
- [ ] T014 [P] Add common UI element translations in src/messages/en.json (buttons, labels, placeholders, error messages)
- [ ] T015 [P] Add common UI element translations in src/messages/ru.json
- [ ] T016 [P] Add common UI element translations in src/messages/ar.json
- [ ] T017 [P] Translate homepage content in src/messages/en.json
- [ ] T018 [P] Translate homepage content in src/messages/ru.json
- [ ] T019 [P] Translate homepage content in src/messages/ar.json
- [ ] T020 [P] Translate about/documentation pages in src/messages/en.json
- [ ] T021 [P] Translate about/documentation pages in src/messages/ru.json
- [ ] T022 [P] Translate about/documentation pages in src/messages/ar.json
- [ ] T023 [P] Implement loading state component in src/components/ui/loading-state.tsx with estimated time display (FR-031)
- [ ] T024 [P] Implement copy-to-clipboard button component in src/components/ui/copy-button.tsx with success feedback (FR-032)
...
- [ ] T025 [P] [US1] Verify story-creator tool config in src/config/tools/story-creator.ts matches data model specifications
- [ ] T026 [P] [US1] Verify existing system prompts in prompts/story/general/ (en.md, ru.md, ar.md) match modern prompt engineering structure from research.md
- [ ] T027 [P] [US1] Update story creator translations in src/messages/en.json
- [ ] T028 [P] [US1] Update story creator translations in src/messages/ru.json
- [ ] T029 [P] [US1] Update story creator translations in src/messages/ar.json
- [ ] T030 [US1] Test story creator with command-line script scripts/test-story-creator.js - verify English output
- [ ] T031 [US1] Test story creator with Russian language - verify Cyrillic output with modern slang
- [ ] T032 [US1] Test story creator with Arabic language - verify Arabic output with RTL formatting
